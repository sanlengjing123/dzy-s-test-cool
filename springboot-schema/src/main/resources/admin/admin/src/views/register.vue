    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="login-form">
      <h1 class="h1">哈勃远诊系统注册</h1>
        ...
        <el-input v-model="ruleForm.youxiang" placeholder="邮箱"></el-input>
                                                ...
                                                <el-form-item v-if="tableName=='qiyexinxi'" label="医生编号" prop="qiyexinxiqiyebianhao">
        <el-input v-model="ruleForm.qiyebianhao" placeholder="医生编号"></el-input>
      </el-form-item>
                        <el-form-item v-if="tableName=='qiyexinxi'" label="密码" prop="qiyexinximima">
        <el-input v-model="ruleForm.mima" placeholder="密码"></el-input>
      </el-form-item>
                        <el-form-item v-if="tableName=='qiyexinxi'" label="医生姓名" prop="qiyexinxiqiyemingcheng">
        <el-input v-model="ruleForm.qiyemingcheng" placeholder="医生姓名"></el-input>
      </el-form-item>
        ...
        <el-input v-model="ruleForm.lianxidianhua" placeholder="联系电话"></el-input>
                        ...
                        <el-form-item v-if="tableName=='qiyexinxi'" label="医生邮箱" prop="qiyexinxiqiyeyouxiang">
        <el-input v-model="ruleForm.qiyeyouxiang" placeholder="医生邮箱"></el-input>
      </el-form-item>
