  ...
  <div>
    ...
    >
      <el-row>
          ...
          <el-form-item v-if="ruleForm.dianhua" label="电话" prop="dianhua">
              <el-input v-model="ruleForm.dianhua" 
                placeholder="电话" readonly></el-input>
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="type!='info'" label="采集图片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="采集图片" prop="zhaopian">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xueli" label="病历本" prop="xueli">
              <el-input v-model="ruleForm.xueli" 
                placeholder="病历" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="12">
        <el-form-item v-if="type!='info'"  label="医师类别" prop="gangweileibie">
          <el-select v-model="ruleForm.gangweileibie" placeholder="请选择问诊医师类别">
            <el-option
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gangweileibie" label="医师类别" prop="gangweileibie">
              <el-input v-model="ruleForm.gangweileibie" 
                placeholder="医师类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="type!='info'" label="病历本" prop="jianli">
          <file-upload
          tip="点击上传病历本"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jianli" label="病历" prop="jianli">
            <el-button type="text" size="small" @click="download(ruleForm.jianli)">下载</el-button>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'" label="仪器版本" prop="gongzuojingli">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuojingli" label="工作经历" prop="gongzuojingli">
                    <span>{{ruleForm.gongzuojingli}}</span>
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="病症描述" prop="gerenjibenqingkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gerenjibenqingkuang" label="病症描述" prop="gerenjibenqingkuang">
